    ...
    void play() throws CricketBiteException, SnakeBiteException, VultureBiteException, TrampolineException {
        ...
        while(location != total_tiles){
            ...
            if(flag_forward || location == 1){
                die = this.dieThrow();
                System.out.print("[Roll-" + roll + "]: " + this.player_name + " rolled " + die + " at Tile-" + location + ", ");
                roll++;
            }
            if(flag_cage){
                if(die == 6){
                ...
                if((die + location) > total_tiles){
                    ...
                    try{
                        ...
                        System.out.println("landed on tile " + location);
                        System.out.println("         " + player_name + " wins the race in " + (roll-1) + " moves");
                ...
                try{
                    ...
                    if(location < 1){
                        location = 1;
                        System.out.println("         " + player_name + " moved to tile-" + location + ", as it can't go back further.");
                        flag_cage = true;
                    }
                        ...
                        System.out.print("         " + player_name + " moved to tile-" + location);
                    }
                }
