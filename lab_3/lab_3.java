...
class Thief extends Hero{
    ...
    void special(Monster monster){
        ...
        this.set_hp(1.3 * monster.get_hp());
...
class Mage extends Hero{
    ...
    void special(Monster monster){
        this.setSpecial(true);
        this.setSpecial_moves(3);
        System.out.println("For next 3 moves monster hp decreased by " + (0.05 * monster.get_hp()));
...
class Healer extends Hero{
    ...
    void special(Monster monster){
        this.setSpecial(true);
        this.setSpecial_moves(3);
        System.out.println("For next 3 moves hp increased by " + 0.05*this.get_hp());
